...
function printNumbers (firstNumber,secondNumber) {
    console.log("First number: " + firstNumber,"secound number: " + secondNumber);
...
const Hello = createGreeting("Lisa");
const nameContainer = document.querySelector("#name");
nameContainer.innerHTML = Hello;
